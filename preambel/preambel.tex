...
% LaTeX - Preambel  ***************************************************************
% ---------------------------------------------------------------------------------
% auf Basis der Vorlage von Matthias Pospiech http://www.matthiaspospiech.de/latex/
% angepasst durch Marco Wirth
...
% Laden der globalen Informationen der Ausarbeitung
\input{content/00-Informationen}
%
...
\bibliographystyle{bibliography/bst/AlphaDINFirstName}
...
%   % PDF Informationen
%    pdftitle={\titelWA},		% Titel
%    pdfauthor={\authorWA},		% Autor
%    pdfsubject={\subjectWA},		% Art der Arbeit
%    pdfkeywords = {\keywordsWA},		% Schlagwörter
